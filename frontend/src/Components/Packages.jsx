  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            className={`container px-5 pt-12 mt-10 mx-auto ${
              theme === "dark" ? "bg-black text-white" : "bg-white text-black"
            }`}
          >
            <div
                ...
                <div className="h-full rounded-lg overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <h1 className="title-font text-lg font-medium text-black mb-3">
                      @codeeasy/autotailwindcss
                    </h1>
                    <p className="leading-relaxed mb-3">
                      A package to configure Tailwind CSS
                    </p>
                    <div className="flex items-center flex-wrap ">
                      <a className="text-indigo-400 inline-flex items-center md:mb-2 lg:mb-0">
                        npm i @codeeasy/autotailwindcss
                      </a>
              ...
              >
                <div className="h-full rounded-lg overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center flex-wrap ">
                      <a className="text-indigo-400 inline-flex items-center md:mb-2 lg:mb-0">
                        npm i @codeeasy/tailandmaterial
                      </a>
                      <span className="text-gray-500 mr-3 inline-flex items-center lg:ml-auto md:ml-0 ml-auto leading-none text-sm pr-3 py-1 border-r-2 border-gray-800">
                        <svg
                          className="w-4 h-4 mr-1"
